...
Locales['en'] = {
  -- BOSS MENU:
  ['boss_menu']             	= '[E] To Open Boss Actions',
  ['employee_menu']           = 'personnel',
  ['accounts_menu']           = 'Bank account',
  ['boss_menu_title']         = 'Boss Actions',
  
  -- EMPLOYEES:
  ['btn_employee_list']       = 'Employee List',
  ['btn_employee_reqruit']    = 'Get Employees',
  ['employee_menu_title']     = 'management',
  ['employee']               	= 'Employee',
  ['grade']                  	= 'Grade',
  ['actions']                	= 'Actions',
  ['fire']                   	= 'Fire',
  ...
  ['return_test_veh']      	    = '[~r~E~w~] To Return the Vehicle',
  ...
  -- DISPLAY VEHICLE:
  ['swap_car_label']           	= '[~g~E~w~] to change',
  ['confirm_cancel_purchase']   = '[~g~E~w~] Sign Papers | [~r~BACKSAPCE~w~] to cancel',
  ['min_commission_limit']     	= 'You reached minimum allowed commission',
  ['max_commission_limit']     	= 'You reached maximum allowed commission',
  ['confirm_cancel_finance']    = '[~g~F~w~] Sign Financing Papers | [~r~BACKSAPCE~w~] to cancel',
