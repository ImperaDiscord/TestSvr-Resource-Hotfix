...
ESX.RegisterServerCallback('esx_ambulancejob:removeItemsAfterRPDeath', function(source, cb)
	...
	if Config.RemoveCashAfterRPDeath then -- Modified to remove HALF yer cash
		if xPlayer.getMoney() > 0 then
			local cashvar = 0.5 -- Scale, this is percent
			cashvar = xPlayer.getMoney() * cashvar
			xPlayer.removeMoney(cashvar)
		end
