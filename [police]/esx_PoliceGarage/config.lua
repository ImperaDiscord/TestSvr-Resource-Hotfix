...
Config.HeliDraw3DText = "Press [E] To open the garage"		-- set your desired text here
...
Config.BoatDraw3DText = "Press [E] To open the garage"		-- set your desired text here
