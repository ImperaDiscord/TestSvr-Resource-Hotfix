...
OpenPoliceArmory = function()
	...
	local elements = {
		{ ["label"] = "Weapons Storage", ["action"] = "weapon_storage" },
		{ ["label"] = "Deposited Weapons", ["action"] = "weapon_supp" }
	}
	...
	function(data, menu)
		...
		elseif action == "weapon_supp" then
			...
			ESX.ShowNotification("You have laid down your arms.")
		end		
