...
function OpenPoliceActionsMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'police_actions', {
		...
		elements = {
			...
			{label = '<span style="color:#669999;">LSPD equipment<span style="color:cyan;"> >', value = 'lspd_equipement'},
			{label = '<span style="color:#669999;">Give a fine<span style="color:cyan;"> >', value = 'ammende'},
			{label = '<span style="color:#ff6600;">Reinforcement request<span style="color:cyan;"> >', value = 'renfort'}
	}}, function(data, menu)
		if data.current.value == 'citizen_interaction' then
			...
			if PlayerData.job and PlayerData.job.name == 'police' and PlayerData.job.grade_name == 'chef' or PlayerData.job.grade_name == 'boss' then
				table.insert(elements, {label = 'Give the weapon license', value = 'ppa'})
			end
		...
		elseif data.current.value == 'menu_menottes' then
			...
			local elements = {
				{label = '<span style="color:green;">Put on<span style="color:white;"> handcuffs', value = 'handcuff'},
				{label = '<span style="color:red;">Remove<span style="color:white;"> handcuffs', value = 'handcuff2'},
		...
		elseif data.current.value == 'lspd_equipement' then
			...
			if grade == 'recruit' then
				table.insert(elements, {label = ('Cadet equipment'), value = 'equipement_cadet'})
			elseif grade == 'officer' then
				table.insert(elements, {label = ('Officer equipment'), value = 'equipement_officier'})
			elseif grade == 'sergeant' then
				table.insert(elements, {label = ('Sergeant equipment'), value = 'equipement_sergeant'})
			elseif grade == 'lieutenant' then
				table.insert(elements, {label = ('Lieutenant equipment'), value = 'equipement_lieutenant'})
			elseif grade == 'boss' then
				table.insert(elements, {label = ('CMD equipment'), value = 'equipement_cmd'})
			end
